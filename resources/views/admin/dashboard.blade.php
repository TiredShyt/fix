...
@section('content')
    ...
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            Barangay Preparedness Dashboard
        </h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            <h3 class="text-4xl font-bold text-green-600">2</h3>
            <p class="text-gray-500 mt-2">33% of total</p>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            <h3 class="text-4xl font-bold text-yellow-600">2</h3>
        ...
        <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
            ...
            <h3 class="text-4xl font-bold text-red-600">2</h3>
